...
@Component({
  selector: 'app-pet-deposit-page',
  templateUrl: './pet-deposit-page.page.html',
  styleUrls: ['./pet-deposit-page.page.scss'],
})
export class PetDepositPagePage implements OnInit {  id = "";
name = "";
category = "";
p_category = "";
age = "";
...
save() {
  this.session.ajax(this.session.api + "pet-deposit-page.php", {
    anm_id: this.id,
    anm_name: this.name,
